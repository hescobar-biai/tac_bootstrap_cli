"""Runtime Router - Endpoints for runtime agents, prompts, logs, and workflows."""
...
async def list_workflows(
    ...
    limit: int = Query(20, ge=1, le=100, description="Max workflows to return"),
) -> list[dict[str, Any]]:
    """List ADW workflows from ai_developer_workflows table."""
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to read workflows: {e}")
