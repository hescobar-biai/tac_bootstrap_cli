...
6. Logs all events to database for tracking

Usage:
    uv run adws/adw_workflows/adw_plan_build_review.py --adw-id <uuid> --prompt "task description" --working-dir /path/to/project
