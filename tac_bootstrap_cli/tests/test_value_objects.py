...
class TestSemanticVersion:
    ...
    def test_less_than_comparison(self):
        ...
        assert SemanticVersion("0.2.0") < SemanticVersion("0.10.1")
    ...
    def test_comparison_major_version(self):
        ...
        assert SemanticVersion("1.0.0") > SemanticVersion("0.10.1")
    ...
    def test_comparison_minor_version(self):
        ...
        assert SemanticVersion("0.10.1") > SemanticVersion("0.2.9")
