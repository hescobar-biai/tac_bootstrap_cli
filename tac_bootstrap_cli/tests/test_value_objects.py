...
class TestSemanticVersion:
    ...
    def test_less_than_comparison(self):
        ...
        assert SemanticVersion("0.2.0") < SemanticVersion("0.9.7")
    ...
    def test_comparison_minor_version(self):
        ...
        assert SemanticVersion("0.9.7") > SemanticVersion("0.2.9")
