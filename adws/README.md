...
Este directorio contiene los workflows automatizados para tac-bootstrap.
...
```bash
uv run python adws/adw_sdlc_iso.py --issue 123
```
...
```bash
uv run python adws/adw_patch_iso.py --issue 456
```
...
Los worktrees se crean en `trees/`.
