...
All domain models extend `Entity` from `src/shared/domain/base_entity.py`:
...
| [config.py.md](shared/config.py.md) | Pydantic Settings configuration |
...
| [dependencies.py.md](shared/dependencies.py.md) | FastAPI dependency injection |
| [health.py.md](shared/health.py.md) | Health check endpoints |
| [alembic.py.md](shared/alembic.py.md) | Database migrations setup |

## Delete Behavior

By default, entities use **soft delete** (state=2):
