...
First, verify if `src/shared/` exists. If not, create it.

```bash
# Check if shared infrastructure exists
ls src/shared/domain/base_entity.py 2>/dev/null || echo "MISSING"
```
...
mkdir -p src/{capability}/domain
mkdir -p src/{capability}/application
mkdir -p src/{capability}/infrastructure
mkdir -p src/{capability}/api
```

Create `__init__.py` files:
```bash
touch src/{capability}/__init__.py
touch src/{capability}/domain/__init__.py
touch src/{capability}/application/__init__.py
touch src/{capability}/infrastructure/__init__.py
touch src/{capability}/api/__init__.py
```

## Step 3: Create Domain Model

**File**: `src/{capability}/domain/{entity}.py`
...
**File**: `src/{capability}/application/schemas.py`
...
**File**: `src/{capability}/application/service.py`
...
**File**: `src/{capability}/infrastructure/models.py`
...
**File**: `src/{capability}/infrastructure/repository.py`
...
**File**: `src/{capability}/api/routes.py`
...
Add the new router to `src/main.py`:
