...
- Follow DDD (Domain-Driven Design) architecture patterns if applicable
...
- `cd tac_bootstrap_cli && uv run ruff check .` - Run linter
- `cd tac_bootstrap_cli && uv run mypy tac_bootstrap/` - Run type checker
