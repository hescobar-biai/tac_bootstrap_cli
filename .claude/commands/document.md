...
Generate markdown documentation for implemented features in tac-bootstrap by analyzing code changes and specifications.
...
- Create file in `app_docs/` with name: `feature-{adw_id}-{descriptive-name}.md`
...
- `tac_bootstrap_cli/<path>`: <what was changed/added>
...
- IMPORTANT: Return exclusively the path to the documentation file created.
