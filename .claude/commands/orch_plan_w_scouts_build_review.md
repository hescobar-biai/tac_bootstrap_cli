...
# Plan with Scouts → Build → Review Orchestrator
...
- 🔨 Build Phase: Sequential implementation
- ✅ Review Phase: Quality assessment
```
...
Save plan to specs/ directory using relative path: specs/orch-plan-{timestamp}.md
...
- Review Phase: [✓ Complete or ✗ Failed or ⚠ Warning]
